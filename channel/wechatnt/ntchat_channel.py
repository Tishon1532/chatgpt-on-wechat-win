...
class NtchatChannel(ChatChannel):
    ...
    def handle_group(self, cmsg: ChatMessage):
        ...
        elif cmsg.ctype in [ContextType.LEAVE_GROUP,ContextType.JOIN_GROUP,ContextType.EXIT_GROUP, ContextType.PATPAT]:
    ...
    def send(self, reply: Reply, context: Context):
        ...
        if reply.type == ReplyType.TEXT or reply.type == ReplyType.TEXT_:
            ...
            wechatnt.send_image(receiver,reply.content)
            logger.info("[WX] sendImage, receiver={}".format(receiver))
        elif reply.type == ReplyType.VIDEO:  # 发送文件
            wechatnt.send_video(receiver,reply.content)
            ...
            wechatnt.send_gif(receiver, reply.content)
            logger.info("[WX] sendCARD={}, receiver={}".format(reply.content, receiver))
        elif reply.type == ReplyType.CALL_UP:
            wechatnt.send_call_up(receiver)
