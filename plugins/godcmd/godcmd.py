        ...
        if content.startswith("#"):
            ...
            if any(cmd in info["alias"] for info in COMMANDS.values()):
                ...
                if cmd == "auth":
                    ...
                    if bottype in [const.OPEN_AI, const.CHATGPT, const.CHATGPTONAZURE, const.LINKAI,const.CLAUDEAPI,const.XUNFEI,
                                   const.BAIDU, const.GEMINI,const.DEEPSEEK,const.COZE, const.QWEN, const.GEMINI, const.ZHIPU_AI,const.DIFY]:
                ...
                if isadmin:
                    ...
                    if cmd == "stop":
                        ...
                        if bottype in [const.OPEN_AI, const.CHATGPT, const.CHATGPTONAZURE, const.LINKAI,const.CLAUDEAPI,const.XUNFEI,
                                       const.BAIDU, const.GEMINI,const.DEEPSEEK,const.COZE, const.QWEN,const.ZHIPU_AI, const.MOONSHOT,const.DIFY]:
